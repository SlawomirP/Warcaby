...
public class BoardText {
    ...
    public static final String COMP_TURN = "Computer turn";
    public static final String PLAYER_RESULT = "Player resutl: ";
    public static final String COMP_RESULT = "Computer result: ";
    public static final String PLAYER_WIN = "GREAT! You win";
    public static final String PLAYER_LOST = "Unfortunately you lost";
}
